"""
Django settings for morning_mud_dev_60713 project.
...
ROOT_URLCONF = 'morning_mud_dev_60713.urls'
...
WSGI_APPLICATION = 'morning_mud_dev_60713.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_mud_dev_60713 API",
    "DESCRIPTION": "API documentation for morning_mud_dev_60713 App",
    "VERSION": "v1",
}
